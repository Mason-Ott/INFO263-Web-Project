...
try {
    $db = new PDO('sqlite:RentalSimV8Logging.2024-08-09.db');
...
$offset = isset($_GET['offset']) ? (int)$_GET['offset'] : 0; // Cast to int for safety
$limit = isset($_GET['limit']) ? (int)$_GET['limit'] : 25; // Cast to int for safety
